...
function goToStory() {
    ...
    let storyScreen = document.getElementById('story-wrapper')
    menuScreen.style.visibility = 'hidden';
    storyScreen.style.display = 'block';
    //save user
    let userFistName = document.getElementById('name');
    newUser = new User(userFistName);
    newUser.setUserInLocal();
    newUser.showCurrentName();
    setMonsterNameInHTML();
    $("#menuTheme").trigger('pause');
    $("#magic-sound").trigger('play');
    $('#gameTheme').trigger('play');
